...
<input type="radio" name="field_active" value="on" {if $field.active == 'on'} checked="checked"{/if} /> afficher
<input type="radio" name="field_active" value="off" {if $field.active != 'on'} checked="checked"{/if} /> masquer
