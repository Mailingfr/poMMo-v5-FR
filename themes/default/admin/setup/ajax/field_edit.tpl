...
<fieldset>
<legend>Param&egrave;tres du champ '{$field.name}'</legend>
...
<input type="radio" name="field_required" value="on"{if $field.required == 'on'} checked="checked"{/if} /> oui
<input type="radio" name="field_required" value="off"{if $field.required != 'on'} checked="checked"{/if} /> non
...
<input type="radio" name="field_active" value="on" {if $field.active == 'on'} checked="checked"{/if} /> oui
<input type="radio" name="field_active" value="off" {if $field.active != 'on'} checked="checked"{/if} /> non
...
<option value="on"{if $field.normally == 'on'} selected="selected"{/if}>Coch&eacute;e [ON]</option>
<option value="off"{if $field.normally == 'off'} selected="selected"{/if}>Non Coch&eacute;e [OFF]</option>
</select>
<div class="notes">{t}If provided, this value will appear pre-filled on the subscription form{/t}</div>
</div>
