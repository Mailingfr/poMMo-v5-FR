...
<div>
<a href="{$url.base}admin/mailings/tracking_menu.php"><img src="{$url.theme.shared}images/icons/trackings.png" alt="trackings icon" class="navimage" />{t}Statistiques{/t}</a> - Voir les statistiques des messages (ouvertures, clics).
</div>
