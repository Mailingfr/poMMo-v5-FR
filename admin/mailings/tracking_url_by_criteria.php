...
if(isset($_GET['group_name']) and $_GET['group_name']!='/' and $_GET['group_name']!=NULL){
    ...
    else
    {
        ...
        $titre_aff = "Tous les clics enregistr&eacute;s depuis le groupe <span style=\"color:orange\">".$group_name."</span>";
    }
}
...
while($rowtitre = $result_titre->fetch())
	{
	$titre_aff = "Tous les clics enregistr&eacute;s depuis le message intitul&eacute; <span style=\"color:orange\">".$rowtitre[subject]."</span> (ID-".$rowtitre[mailing_id].").";
	}
$result_titre = NULL;
}
